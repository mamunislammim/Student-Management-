...
class SetStudentInfoScreen extends StatefulWidget {
  const SetStudentInfoScreen({Key? key}) : super(key: key);

  @override
  State<SetStudentInfoScreen> createState() => _SetStudentInfoScreenState();
}

class _SetStudentInfoScreenState extends State<SetStudentInfoScreen> {
